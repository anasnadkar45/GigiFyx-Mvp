...
const sidebarLinks = [
  ...
  },
  {
    category: "SERVICES",
    links: [
      { id: 3, name: "Dental Services", href: "/clinic/services", icon: Stethoscope },
      { id: 4, name: "Treatment Plans", href: "/clinic/treatments", icon: Clock },
    ],
  },
  {
    category: "MARKETPLACE",
    links: [
      { id: 5, name: "Find Clinics", href: "/marketplace/clinics", icon: Globe },
      { id: 6, name: "Contact Support", href: "/support", icon: Phone },
    ],
  },
]
